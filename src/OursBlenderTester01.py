...
# Extended from OursBlenderTester02.py for FER004 models
...
class DpgVideoPredictor:
    ...
    def load_data(self, video_name, seq_num, pred_frame_nos):
        ...
        for frame_num in gt_frame_nos:
            frame_path = self.database_dirpath / f'all_short/RenderedData/{video_name}/seq{seq_num:02}/rgb/{frame_num:04}.png'
